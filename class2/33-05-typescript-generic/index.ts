...
// <MyType> => 이건 MyType을 사용하겠다는 뜻
// 한번 함수에 들어가서 타입이 지정되면 그대로 유지된다
...
console.log(result7); //[number,string, string] => 타입 유지
...
const result8 = getGenericReverse<string, string, number>("철수", "명수", 8);
console.log(result8);
// 꺾쇠 안에 있는것이 제네릭
